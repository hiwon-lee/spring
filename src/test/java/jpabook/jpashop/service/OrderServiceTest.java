...
class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Item item = createBook("seegol JPA", 10000, 10);  // 이름, 가격, 재고
        int orderCount = 2;
        ...
        assertEquals(OrderStatus.ORDER, getOrder.getStatus(), "상품 주문시 상태는 ORDEEEEEEEEEEEEEER");
    ...
    public void 주문취소() {
        ...
        assertEquals(OrderStatus.ORDER, getOrder.getStatus(), "주문 취소시 상태는 cancel이다.");
